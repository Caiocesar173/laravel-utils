...
use Caiocesar173\Utils\Entities\Language as EntitiesLanguage;
...
class LanguageMaps extends Seeder
{
    ...
    public function run() {
        ...
        foreach ($languages as $language) 
        {
            ...
            $language = EntitiesLanguage::where('code', $languageName)->first();
            ...
            LanguageMap::create($language);
            $this->command->info('Inserted language from' . $language['name'] . ' [' . count($language) . ']..');
        }
